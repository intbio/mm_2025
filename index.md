...
### Course calendar
- Dates: 12/2/2025; 19/2/2025; 26/2/2025; 5/3/2025; 12/3/2025; 19/3/2025; 26/3/2025; 2/4/2025;  16/4/2025; 23/4/2025; 30/4/2025; 7/5/2025?; 14/5/2025; 
...
<a href="https://www.dropbox.com/scl/fi/qrdktpsdmbmru2gcwaiqh/Lecture1_new.ppt?rlkey=cs2vo08kaariscomm77kbamb4&dl=0">Слайды лекции.</a> 
<a href="">Запись лекции.</a> 
<br>
...
<a href="https://www.dropbox.com/scl/fi/t91l9w92zsuowshn7ql7v/Lecture4.ppt?rlkey=gvfkl5ukl5hczo7wks0ory8ef&dl=0">Слайды лекции.</a> 
</details>
...
<a href="https://www.dropbox.com/scl/fi/mk18nqvappldmvbx8wqyw/Lecture5.ppt?rlkey=i7ub5c9q23g3m19iozdhxjwp7&dl=0">Слайды лекции.</a> 
</details>
...
<details><summary><ins>Лекция 8</ins> Методы предсказания структры белков и биомакромолекулярных комплексов.</summary> Постановка задачи, почему необходимы методы предсказания? Проблема фолдинга белка. Догма Анфинсена. Парадокс Левинталя. Физические механизмы фолдинга белка. Соотношение между похожестью последовательности и структурой. Типы подхдов к предсказанию. Конкурс CASP.  Метрики качества: RMSD, GDT, (p)LDDT, PAE, TM-score, pTM. ipTM. Моделирование по гомологии: воздание выравнивания, оценка качества модели. Методы детекции фолда (протягивание). Поиск гомологов и предсказание структуры на основе скрытых марковских моделей: HHPRED. Физические методы моделирования и предсказания ab initio: МД, Rosetta/Robetta, сборка белка из фрагментов (fragment based assembly). Гибридные подходы: iTASSER. Коэволюционные подходы. Нейросетевые подходы: AlphaFold, RoseTTAFold, ESMFold, OmegaFold, EMBER3D, AlphaFold3. Моделирование комплексов и взаимодействий:  AlphaFoldMultimer, AlphaFold3, Boltz, Chai, Neo, RoseTTAFoldNA, RF2-ppi. Сервера и базы данных: ВFD, MMseq2, AlphaFoldDB, FoldSeek. CollabFold. Ограничения методов предсказания структуры белка.
